...
builder.Services.AddSwaggerGen(c =>
{
    ...
    // 没有特性的接口分到NoGroup上
    c.SwaggerDoc("NoGroup", new OpenApiInfo { Title = "无分组" });
    // 判断接口归于哪个分组
...
builder.Services.AddDbContext<SnblogContext>(options =>
    options.UseMySql(
...
if (app.Environment.IsDevelopment())
{
    ...
    _ = app.UseSwagger(); // `UseSwaggerUI` UseKnife4UI
